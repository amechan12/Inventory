                ...
                <form action="{{ route('profile.photo.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="flex items-center space-x-6">
                        <img id="photo-preview"
                            class="h-24 w-24 rounded-2xl object-cover border-4 border-indigo-100 shadow-lg"
                ...
                <form action="{{ route('profile.update') }}" method="POST" class="space-y-4">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <span
                                class="absolute right-4 top-1/2 transform -translate-y-1/2 px-3 py-1 bg-indigo-500 text-white text-xs font-semibold rounded-full">
                                {{ ucfirst($user->role) }}
                            </span>
                        </div>
                    </div>
        ...
        <div class="lg:col-span-1">
            <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 sticky top-24">
                ...
                <form action="{{ route('profile.password') }}" method="POST" class="space-y-4">
                    ...
                    @method('PUT')
                    <div>
                        <label for="current_password" class="block text-sm font-semibold text-gray-700 mb-2">Password Saat
                            Ini</label>
                        ...
                        @error('current_password', 'updatePassword')<p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
